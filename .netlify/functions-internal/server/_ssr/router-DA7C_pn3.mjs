	...
	if (isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex size-12 items-center justify-center rounded-full bg-ally text-lg font-bold text-ally-foreground animate-pulse",
					children: "A"
				})
...
var Route$1 = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "A mock Ally Bank mobile banking interface with accounts, transaction history, transfers and a credit card application flow. Demo data only."
		},
		{
			property: "og:title",
			content: "Ally Bank Mobile Demo"
		},
		{
			property: "og:description",
			content: "Mock mobile banking UI: accounts, transactions, restricted-transfer alert and card application flow."
		},
		{
			name: "robots",
			content: "noindex"
	...
	beforeLoad: () => {
		if (!(typeof window !== "undefined" && window.localStorage.getItem("isLoggedIn") === "true")) throw redirect({ to: "/login" });
	},
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./login-BNFKHeEW.mjs");
var Route = createFileRoute("/login")({
	head: () => ({ meta: [{ title: "Ally Bank - Log In" }, {
		name: "description",
